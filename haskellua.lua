...
for i,v in ipairs{"max","min","abs","pi","exp","log","sqrt","sin","cos","tan","asin","acos","atan","sinh","cosh","tanh","floor","ceil","atan2","max"}do
	_ENV[v] = math[v]
end ceiling = ceil
...
-- pi, exp, log, sqrt, sin, cos, tan, asin, acos, atan, sinh, cosh, and tanh are covered by math (61)
...
-- ceiling and floor covered by math (61)

round   = function(a)
	return toInteger(a + (2^52 + 2^51) - (2^52 + 2^51)) --...i have no idea how this works. https://stackoverflow.com/a/58411671
end
